...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `95b040b1` | Pending build | Pending | — | On custom — `All media` peut masquer les séries à jour selon les épisodes réellement sortis; 76 tests Home, Ruff et contrôle Django verts |
