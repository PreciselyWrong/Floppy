...
| UI-001 | Appearance and detail layouts | `feat/user-appearance` | `b6a1c25b` | — | Pending | — | On custom — hover non découpé, audit corrigé, 45 tests Appearance, Ruff ciblé et Tailwind stable; déploiement requis |
