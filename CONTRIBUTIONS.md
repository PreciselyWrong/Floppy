...
| UI-002 | Direct horizontal carousel gestures | `feat/horizontal-swipe` | `5a5b85fe` | — | Pending | — | On custom — Home, casting, recommandations, aperçus, statistiques et titres suivis; 224 tests ciblés verts |
