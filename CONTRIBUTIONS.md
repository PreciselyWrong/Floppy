...
| UI-001D | Custom branding | `feat/custom-branding-clean` | `f1d32841` | `sha-754e5b13aadca99727a485f2d548ad805f245501` | Pending | — | Current Unraid image saves Appearance instead of publishing when Nicolas clicks the sign-in button; fix ported to `custom` at `5eb765f9`, with 68 targeted tests, Ruff and nine browser screenshots passing; redeployment and Nicolas's test pending before PR approval |
