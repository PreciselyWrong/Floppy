...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `0ff7ca1f` | Pending build | Pending | — | Validated — regroupement réparé avec les données réelles, lectures non terminées masquées et bulles personnalisables; 83 tests ciblés, Ruff, migration et Tailwind verts |
