...
|---|---|---|---|---|---|---|---|
| DETAIL-003 | Plex, Radarr and Sonarr availability on details | `feat/detail-availability` | `b45b56b1` | Pending | Pending | — | On custom — correctif épisode validé par 9 tests ciblés et Ruff |
...
| DETAIL-002 | Public reviews from TMDB, BetaSeries and Hardcover | `fix/public-reviews-appearance` | `6fd93794` | `sha-a973e54c3b316b133554418c1d2656283ad07b38` | Pending | — | Deployed — Appearance répond en 200, Public reviews est présent pour Episodes, les anciens contrôles ont disparu et le préflight Unraid est vert |
