...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `fe8bdd58` | `sha-4eb358679e1a017cc754f1478defa145b16450f9` | Pending | — | Deployed — les anciens visionnages sans jaquette ne font plus tomber Home; 38 tests Home, rendu réel en 200 et préflight vert |
