...
| DETAIL-002 | Public reviews from TMDB, BetaSeries and Hardcover | `feat/public-reviews` | `93c17965` | Pending build | Pending | — | On custom — avis replacés après le synopsis, débordement mobile corrigé et repli TMDB multilingue validés par 61 tests; clé BetaSeries configurée dans le modèle Unraid |
