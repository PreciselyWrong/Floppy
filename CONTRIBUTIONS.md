...
| DETAIL-002 | Public reviews from TMDB, BetaSeries and Hardcover | `fix/public-reviews-appearance` | `6fd93794` | Pending build | Pending | — | Validated — avis configurables et réordonnables par famille dans Appearance > Detail pages; anciens choix migrés; 38 tests ciblés, Ruff et Django verts |
