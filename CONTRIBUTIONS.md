...
| PWA-001 | Installable app experience | `feat/pwa-install` | `0a810b38` | — | Pending | — | On custom — installation Chromium, guide iOS, mode standalone et paysage; 11 tests ciblés verts |
