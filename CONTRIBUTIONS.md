...
| UI-001 | Appearance and detail layouts | `feat/user-appearance` | Pending | `sha-edad752ca966ccb5b0cb98b2161747e6ed5d00f6` | Changes requested | — | Development — fermeture des overlays et titres longs d’épisode corrigés; validation en cours |
