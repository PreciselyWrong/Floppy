...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `fdc08ade` | `sha-80cf20554c12b13e34c6e71a4fbf11bd14908a2d` | Pending | — | On custom — bulles de type, Activity Journal réparé et Stale limité aux épisodes réguliers diffusés non vus; 46 tests combinés et Ruff validés |
...
| HOME-008 | Configurable Home history row | `feat/home-history-row` | `a024c225` | `sha-a6762b17070dd7e56c0cfa23fcea3ad455558334` | Pending | — | On custom — le mode All media conserve désormais tous les visionnages; 8 tests History Row et Ruff validés |
