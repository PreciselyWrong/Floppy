...
| UI-002 | Direct horizontal carousel gestures | `feat/horizontal-drag-upstream` | `30f10c04` | `sha-6a89a7fe49f462f8d99875cb4672248c802d5e2f` | Works | — | Deployed — double review, targeted tests, Ruff, browser drag/click QA and Unraid preflight passed; awaiting Nicolas retest |
