...
| HOME-008 | Configurable Home history row | `feat/home-history-row` | `a024c225` | `sha-c83596a259fca9df930acc67699481b191dd77e4` | Pending | — | Deployed — le mode All media conserve désormais tous les visionnages; 8 tests History Row, Ruff et préflight vert |
