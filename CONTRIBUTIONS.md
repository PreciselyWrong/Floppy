...
| UI-001 | Appearance and detail layouts | `feat/user-appearance` | `b6a1c25b` | `sha-a506a220306d7b58280d89ee9b466e070bb017ec` | Pending | — | Deployed — hover non découpé sur tous les bords, 38 tests ciblés, Ruff, Tailwind et préflight verts |
