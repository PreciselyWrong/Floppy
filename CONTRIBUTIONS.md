...
| UI-001 | Appearance and detail layouts | `feat/user-appearance` | `de31f221` | `sha-edad752ca966ccb5b0cb98b2161747e6ed5d00f6` | Pending | — | Deployed — overlays portés au viewport et réglages Home contenus; 13 contrats UI, Ruff, JavaScript, navigateur et préflight verts |
