...
| PERF-001 | Bounded Home pagination and local search | `feat/general-performance` | `b755b07b` | Pending build | Pending | — | On custom — Home hydrate seulement la page demandée et les recherches locales sont limitées en SQL; 64 tests ciblés, Ruff et Django verts |
...
| DETAIL-002 | Public reviews from TMDB, BetaSeries and Hardcover | `fix/public-reviews-appearance` | `8249f726` | Pending build | Pending | — | On custom — les balises spoiler BetaSeries sont masquées et révélables volontairement; 64 tests ciblés, Ruff, Django et CSS sont verts |
...
| SERIES-001 | Series, seasons, credits and person details | `feat/home-all-media-in-progress` | `bd8d12e8` | Pending build | Pending | — | On custom — âge au moment du média et œuvres déjà vues sous chaque crédit; 170 tests ciblés, migration, Ruff, Django et CSS verts |
