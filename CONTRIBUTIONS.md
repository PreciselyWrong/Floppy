...
| UI-001D | Custom branding | `feat/custom-branding-clean` | `f1d32841` | `sha-9e6011fbdd50123c947d39c330b50ba7ea99ac46` | Pending | — | Publish-button fix deployed on Unraid; image, health, migration and Redis preflight, backup and GitHub smoke verified; 68 targeted tests, Ruff and nine browser screenshots pass; Nicolas's signed-out visual test and full Linux suite remain before PR approval |
