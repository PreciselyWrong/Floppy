...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `4cb73773` | `sha-658f31dfc9f04e3d3ba89509d48e627f4af6fd23` | Pending | — | Deployed — Journal en cartes horizontales + Binge groups repliables par jour, étagères, préflight vert |
...
| UI-001 | Appearance and detail layouts | `feat/user-appearance` | Pending | `sha-658f31dfc9f04e3d3ba89509d48e627f4af6fd23` | Changes requested | — | Development — tous les overlays sont portés au viewport et les réglages Home restent dans leur panneau; validation en cours |
