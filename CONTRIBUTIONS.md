...
| UI-002 | Direct horizontal carousel gestures | `feat/horizontal-drag-upstream` | `30f10c04` | `sha-c7b650655dc08564586be05467d0615be16f4881` | Works | — | Integrated in `custom` at `5ab2e688` — double review, targeted tests, Ruff and browser drag/click QA passed; deployment pending |
