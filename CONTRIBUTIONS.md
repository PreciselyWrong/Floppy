...
|---|---|---|---|---|---|---|---|
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `4ed9bd55` | Pending build | Pending | — | Validated — `All media / In progress` exclut les séries rattrapées, y compris pour les réglages existants; 112 tests Home, Ruff, Django et migrations verts |
