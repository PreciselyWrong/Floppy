...
| HOME-009 | Companion Home parity (Shelves, Activity Journal & Binge grouping) | `feat/home-all-media-in-progress` | `81438d7a` | — | Pending | — | On custom — affichage, filtres, navigation mobile et accessibilité validés localement; publication Unraid en préparation |
