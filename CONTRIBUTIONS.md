...
| UI-001D | Custom branding | `feat/custom-branding-clean` | `42b59747` | — | Pending | — | Ported to `custom` at `467aa2e4` with its own migration graph; saved sidebar and published sign-in branding verified in browser, nine screenshots, 67 targeted custom tests, Ruff and strict migration hygiene pass; Linux suite and Nicolas's Unraid test remain before PR approval |
