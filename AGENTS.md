...
- Le centrage et la typographie réglable du logo sont intégrés dans `custom`; les déployer sur `unraid-server`, puis attendre le verdict de Nicolas avant toute proposition de PR.
